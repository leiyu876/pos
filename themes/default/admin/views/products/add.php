            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-6 col-md-offset-1">
                    <div class="standard">
                        ...
                        <div style="display:none" class="well well-sm" id="attr-con"
                        ...
                        <div style="display:none" class="<?= $product ? 'text-warning' : '' ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    if ($suppliers == false) {
                                        ...
                                        foreach ($suppliers as $supplier) {
                                            $cat[$supplier->id] = $supplier->name.' ('.$supplier->company.')';
                                        }
                                    }
                                    echo form_dropdown('supplier', $cat, (isset($_POST['supplier']) ? $_POST['supplier'] : ($product ? $product->supplier1 : '')), 'class="form-control select" id="supplier_nothing" placeholder="' . lang("select") . " " . lang("supplier") . '" required="required" style="width:100%"')
                                    ?>
                                </div>
                            </div>
                            <div class="col-xs-6">
